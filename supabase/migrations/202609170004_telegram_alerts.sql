...
drop policy if exists "telegram_alert_queue_admin_select" on public.telegram_alert_queue;
create policy "telegram_alert_queue_admin_select"
on public.telegram_alert_queue for select
